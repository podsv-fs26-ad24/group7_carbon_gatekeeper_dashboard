...
| BU gauges (one per BU) | actual_co2, bu_budget | arc segment | angular position (CO₂ value), colour hue (status zone), zone segments (under 85% / 85–100% / over budget) | linear (0 → max), categorical zone |
